...
//         return from(this.blogRepository.query(`SELECT * FROM "blog_entity" WHERE id=${id} `))
//     }

//     findByUser(userId: number): Observable<BlogEntry[]> {
//         return from(this.blogRepository.query(
//             `SELECT * FROM "blog_entity" WHERE author=${userId} `)
